    ...
    <section className="w-full max-w-6xl mx-auto px-6 py-32 snap-start">
      <div className="text-center mb-20">
        <h2 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight text-white">
          The <span className="bg-logo-gradient bg-clip-text text-transparent">Trio-Standard</span>
        </h2>
        <p className="text-slate-400 font-light max-w-2xl mx-auto text-lg">
          We bridge the gap between complex engineering and reliable business solutions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {pillars.map((pillar, idx) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-3 text-white/90">{pillar.title}</h3>
